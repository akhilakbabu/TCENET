{------------------------------------------------------------------------------}
{                                                                              }
{  TPrintPreview v3.01 & TPaperPreview v1.0                                    }
...
uses
  ...
  ExtCtrls, Menus, Printers,TCEglobals;
...
var
 ...
 Procedure CalcZoom;
  begin
   FZoom:=MulDiv(PV.PaperWidth,FPixelsPerInch.X * 100,FPixels.X * Screen.PixelsPerInch);
  end;
begin
