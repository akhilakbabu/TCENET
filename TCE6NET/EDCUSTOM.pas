...
uses
  ...
  Forms, Dialogs, StdCtrls, Buttons, Menus,TCEglobals, GlobalToTcAndTcextra;
...
begin
 if clearcustom then parseCustomIN;
end;
...
begin
 if loadcustom then parseCustomIN;
end;
